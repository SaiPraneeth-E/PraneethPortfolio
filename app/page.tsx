  ...
  const projects = [
    {
      ...
      description:
        "Advanced audit tool leveraging OpenAI API and NLP for intelligent document analysis and automated compliance checking.",
      category: "Artificial Intelligence",
      tech: ["OpenAI API", "Python", "NLP", "Flask", "Machine Learning"],
      github: "https://github.com/saipraneeth/auditx-ai",
      live: "#",
      date: "2025",
      team: "Solo Project",
      status: "In Progress",
      features: [
        ...
        "25% improvement in audit efficiency",
    ...
    },
    {
      ...
      description:
        "Intelligent finance tracker combining Streamlit, Gemini Pro API, and scikit-learn for advanced expense forecasting and insights.",
      category: "Machine Learning",
      tech: ["Streamlit", "Gemini Pro API", "Scikit-learn", "Python", "Pandas"],
      github: "https://github.com/saipraneeth/budgetwise-ai",
      live: "#",
      date: "2025",
      team: "Solo Project",
      status: "Completed",
      features: [
        ...
        "Predictive forecasting with 18% accuracy improvement",
    ...
    {
      id: 3,
      title: "Quantapath - Quantum-Powered Path Optimization",
      description:
        "Route optimization system leveraging Google Maps API and quantum algorithms for efficient delivery logistics and transportation.",
      category: "Optimization",
      tech: ["Google Maps API", "Python", "Route Optimization", "Quantum Computing"],
      github: "https://github.com/saipraneeth/quantapath",
      live: "#",
      date: "2025",
      team: "Solo Project",
      status: "In Progress",
    ...
    {
      id: 4,
      title: "LangMate AI based Language Translator",
      description:
        "Full-stack multilingual language translation web application with real-time translation capabilities using Google Translate API.",
      category: "Web Development",
      tech: ["Google Trans API", "HTML", "CSS", "JavaScript", "Flask"],
      github: "https://github.com/saipraneeth/langmate",
      live: "https://ibb.co/KpxRVM21",
      date: "2024",
      team: "Solo Project",
      status: "Completed",
      features: [
