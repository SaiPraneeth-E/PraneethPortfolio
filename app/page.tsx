...
export default function TechPortfolio() {
  ...
  {
  id: 1,
  title: "Auditx AI-Powered Government Auditing",
  description:
  "Built audit tool using OpenAI API with NLP for document analysis. Increased audit efficiency by 25%, reducing manual review time significantly.",
  category: "AI/NLP",
  tech: ["OpenAI API", "NLP", "Python", "Document Analysis"],
  github: "https://github.com/saipraneeth/auditx",
  live: "#",
  date: "2024",
  team: "Solo Project",
  status: "Completed",
  ...
  {
  id: 2,
  title: "Budgetwise AI-Based Expense Tracker",
  description:
  "Developed finance tracker with Streamlit, Gemini Pro API, and scikit-learn. Improved forecasting accuracy by 18%, enhancing user financial insights.",
  category: "AI/ML",
  tech: ["Streamlit", "Gemini Pro API", "Scikit-learn", "Python"],
  github: "https://github.com/saipraneeth/budgetwise",
  live: "#",
  date: "2024",
  team: "Solo Project",
  status: "Completed",
  ...
  "Gemini Pro integration for insights",
  "18% improved accuracy",
  "Interactive Streamlit dashboard",
  ],
  },
  {
  id: 3,
  title: "Quantapath - Quantum Path Optimization",
  description:
  "Designed route optimization with Google Maps API for smarter deliveries. Reduced delivery time by 12%, boosting logistics efficiency.
    ...
    {
      id: 4,
      title: "LangMate - AI Language Translator",
      description:
        "Full-stack multilingual language translation web application with real-time translation using Google Trans API for seamless communication.",
      category: "Full Stack AI",
      tech: ["React", "Node.js", "Google Trans API", "Python", "JavaScript"],
      github: "https://github.com/saipraneeth/langmate",
      live: "https://langmate-demo.com",
      date: "2024",
      team: "Solo Project",
      status: "Completed",
      features: [
        "Real-time multilingual translation",
        "Google Trans API integration",
  ...
  const certifications = [
    {
      ...
      level: "Professional",
      description:
        "Foundation-level AWS certification covering cloud concepts, AWS services, and best practices for cloud architecture.",
    ...
    },
    {
      ...
      level: "Professional",
      description:
        "Advanced AWS certification demonstrating expertise in designing and architecting scalable cloud solutions.",
      skills: ["AWS Architecture", "Cloud Design", "Scalability", "High Availability"],
    },
    {
      id: 3,
      ...
      level: "Foundation",
      description:
        "Foundational knowledge of artificial intelligence concepts, applications, and ethical considerations in AI systems.",
    ...
    },
    {
      ...
      category: "AI/ML",
      level: "Professional",
      description: "Comprehensive training on Generative AI technologies and ChatGPT applications in business development.",
    ...
    },
    {
      ...
      level: "Intermediate",
      description:
        "Advanced Python programming covering object-oriented programming, data structures, and best practices.",
      skills: ["Python", "OOP", "Data Structures", "Programming Best Practices"],
    },
    {
      id: 7,
      ...
      level: "Professional",
      description:
        "Advanced certification demonstrating expertise in Oracle Cloud Infrastructure and Generative AI technologies.",
      skills: ["OCI", "Generative AI", "Cloud Services", "AI Model Development"],
    },
  ]
  ...
  const leadershipRoles = [
    {
      ...
      organization: "ICMC Club",
      duration: "2024-2025",
      description: "Led 20+ members with 30% improvement in participation",
      achievements: [
        "Managed club operations and events",
        "Increased member engagement by 30%",
    ...
    },
    {
      id: 2,
      title: "Correspondent",
      organization: "Chaitra Telugu Association",
      duration: "2023-2025",
      description: "Cultural ambassador and community engagement lead",
      achievements: [
        "Organized cultural events and celebrations",
        "Promoted Telugu language and traditions",
        "Coordinated 10+ major events",
  ...
  const achievements = [
    {
      id: 1,
      title: "Winner - AARUSH Sustainable Hackathon",
      organizer: "SRM University",
      date: "2024",
      description: "Developed innovative solution for sustainable development",
    },
    {
      id: 2,
      title: "Runner up - VITAURA InnovateX",
      organizer: "VIT-AP University",
      date: "2024",
      description: "Advanced to finals with cutting-edge AI solution",
    },
    {
      id: 3,
      title: "Top 3 - Amaravati Quantum Valley Hackathon",
      organizer: "Amaravati Quantum Valley",
      date: "2024",
      description: "Recognized for quantum-powered optimization approach",
    },
  ]
